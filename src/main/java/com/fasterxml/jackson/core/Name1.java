 ...
 */
 final class Name1 extends Name
{
    ...
    @Override  boolean equals(int quad) { return (quad == q); }
    @Override  boolean equals(int quad1, int quad2) { return (quad1 == q) && (quad2 == 0); }
    @Override  boolean equals(int q1, int q2, int q3) { return false; }

    @Override  boolean equals(int[] quads, int qlen) { return (qlen == 1 && quads[0] == q); }
}
