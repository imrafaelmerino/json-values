 ...
 */
  class JsonWriter {
	 ...
	 */
	public static  byte OBJECT_START = '{';
	/**
	 * Helper for writing JSON object end: }
	 */
	public static  byte OBJECT_END = '}';
	/**
	 * Helper for writing JSON array start: [
	 */
	public static  byte ARRAY_START = '[';
	/**
	 * Helper for writing JSON array end: ]
	 */
	public static  byte ARRAY_END = ']';
	/**
	 ...
	 */
	public  void reset(@Nullable OutputStream stream) {
		position = 0;
		target = stream;
		flushed = 0;
	}
