...
public final class JsIntGen implements Gen<JsInt> {
   ...
   * that they are between the specified interval: - {@link Integer#MIN_VALUE} - {@link Short#MIN_VALUE} -
   * {@link Byte#MIN_VALUE} - 0 - {@link Integer#MAX_VALUE} - {@link Short#MAX_VALUE} - {@link Byte#MAX_VALUE}
   *
   * @param min The lower bound of the interval (inclusive).
   * @param max The upper bound of the interval (inclusive).
   * @return A biased JsInt generator.
  ...
  /**
   * Returns a biased generator that produces potential problematic values with a higher probability. These values
   * include: - The lower bound of the interval - The upper bound of the interval {@link Integer#MAX_VALUE} And the
   * following numbers, provided that they are between the specified interval: - {@link Integer#MIN_VALUE} -
