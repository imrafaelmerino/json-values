 ...
 * {@link #arbitrary()} or, if none of the previous suit your needs, from a long generator and the function map:
 *
 * <pre>{@code
 * import fun.gen.Gen;
 * import jsonvalues.JsLong;
...
public final class JsLongGen implements Gen<JsLong> {
   ...
   * include: - {@link Long#MIN_VALUE} - {@link Integer#MIN_VALUE} - {@link Short#MIN_VALUE} - {@link Byte#MIN_VALUE} -
   * 0 - {@link Long#MAX_VALUE} - {@link Integer#MAX_VALUE} - {@link Short#MAX_VALUE} - {@link Byte#MAX_VALUE}
   *
  ...
  /**
   * Returns a biased generator that produces potential problematic values with a higher probability. These values
   * include: - The lower bound of the interval - The upper bound of the interval And the following numbers provided
   * that they are between the specified interval: - {@link Long#MIN_VALUE} - {@link Integer#MIN_VALUE} -
   * {@link Short#MIN_VALUE} - {@link Byte#MIN_VALUE} - 0 - {@link Integer#MAX_VALUE} - {@link Short#MAX_VALUE} -
   * {@link Byte#MAX_VALUE} - {@link Long#MAX_VALUE}
   *
   * @param min The lower bound of the interval (inclusive).
   * @param max The upper bound of the interval (inclusive).
   * @return A biased JsLong generator.
  ...
  /**
   * Returns a biased generator that produces potential problematic values with a higher probability. These values
   * include: - The lower bound of the interval - The upper bound of the interval {@link Long#MAX_VALUE} And the
   * following numbers provided that they are between the specified interval: - {@link Long#MIN_VALUE} -
   * {@link Integer#MIN_VALUE} - {@link Short#MIN_VALUE} - {@link Byte#MIN_VALUE} - 0 - {@link Integer#MAX_VALUE} -
   * {@link Short#MAX_VALUE} - {@link Byte#MAX_VALUE} - {@link Long#MAX_VALUE}
   *
   * @param min The lower bound of the interval (inclusive).
   * @return A biased JsLong generator.
   */
