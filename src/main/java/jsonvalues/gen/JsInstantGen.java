 ...
 * {@link #arbitrary()} or, if none of the previous suits your needs, from an instant generator and the function map:
 *
 * <pre>{@code
 * import fun.gen.Gen;
 * import jsonvalues.JsInstant;
...
public final class JsInstantGen implements Gen<JsInstant> {
   ...
   * include: - The minimum instant value - The maximum instant value
   *
