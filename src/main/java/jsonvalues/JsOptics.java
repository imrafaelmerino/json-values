...
public class JsOptics {
  ...
  public static class JsArrayOptics {
    public final JsArrayS optional = new JsArrayS();
  ...
  public static class JsArrayS {
    ...
    public Option<JsArray, String> str(final JsPath path) {
      if(path.head().isIndex()) throw UserError.pathHeadIsNotAnIndex(path);
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsStr.prism);
    }
    ...
    public Option<JsArray, Boolean> bool(final JsPath path) {
      if(path.head().isIndex()) throw UserError.pathHeadIsNotAnIndex(path);
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsBool.prism);
    }
    ...
    public Option<JsArray, Long> longNum(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsLong.prism);
    }
    ...
    public Option<JsArray, Integer> intNum(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsInt.prism);
    }
    /**
    ...
    public Option<JsArray, Double> doubleNum(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsDouble.prism);
    }
    /**
    ...
    public Option<JsArray, BigDecimal> decimalNum(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsBigDec.prism);
    }
    ...
    public Option<JsArray, BigInteger> integralNum(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsBigInt.prism);
    }
    /**
    ...
    public Option<JsArray, JsObj> obj(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsObj.prism);
    }
    /**
    ...
    public Option<JsArray, JsArray> array(final JsPath path) {
      ...
      return JsOptics.array.lens.value(requireNonNull(path)).compose(JsArray.prism);
    }
    /**
  ...
  public static class JsObjS {
    ...
    public Option<JsObj, String> str(final JsPath path) {
      if(path.head().isKey()) throw UserError.pathHeadIsNotAKey(requireNonNull(path));
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsStr.prism);
    }
    ...
    public Option<JsObj, String> str(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsStr.prism);
    }
    ...
    public Option<JsObj, Boolean> bool(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsBool.prism);
    }
    ...
    public Option<JsObj, Boolean> bool(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsBool.prism);
    }
    ...
    public Option<JsObj, Long> longNum(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsLong.prism);
    }
    ...
    public Option<JsObj, Long> longNum(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsLong.prism);
    }
    ...
    public Option<JsObj, Integer> intNum(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsInt.prism);
    }
    ...
    public Option<JsObj, Integer> intNum(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsInt.prism);
    }
    ...
    public Option<JsObj, Double> doubleNum(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsDouble.prism);
    }
    ...
    public Option<JsObj, Double> doubleNum(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsDouble.prism);
    }
    /**
    ...
    public Option<JsObj, BigDecimal> decimalNum(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsBigDec.prism);
    }
    ...
    public Option<JsObj, BigDecimal> decimalNum(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsBigDec.prism);
    }
    ...
    public Option<JsObj, BigInteger> integralNum(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsBigInt.prism);
    }
    ...
    public Option<JsObj, BigInteger> integralNum(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsBigInt.prism);
    }
    /**
    ...
    public Option<JsObj, JsObj> obj(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsObj.prism);
    }
    ...
    public Option<JsObj, JsObj> obj(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsObj.prism);
    }
    ...
    public Option<JsObj, JsArray> array(final JsPath path) {
      ...
      return JsOptics.obj.lens.value(requireNonNull(path)).compose(JsArray.prism);
    }
    ...
    public Option<JsObj, JsArray> array(final String key) {
      return JsOptics.obj.lens.value(requireNonNull(key)).compose(JsArray.prism);
    }
