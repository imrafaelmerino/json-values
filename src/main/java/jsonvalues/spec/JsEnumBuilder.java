...
public final class JsEnumBuilder {
     ...
     * <p>
     * Aliases provide alternative names for the enum, and they can be used interchangeably when referring to the
     * same specification.
     *
    ...
    public JsSpec build(final String... symbols) {
        return build(Arrays.stream(requireNonNull(symbols)).toList());
    }
