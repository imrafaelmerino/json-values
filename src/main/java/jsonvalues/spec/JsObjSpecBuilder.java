...
public final class JsObjSpecBuilder {
  ...
  private void validateAliases(JsObjSpec spec,
                               Map<String, List<String>> fieldsAlias) {
  ...
  private void validateOrders(JsObjSpec spec,
  ...
  private void validateDocs(JsObjSpec spec,
  ...
  private void validateDefaults(JsObjSpec spec,
                                Map<String, JsValue> fieldsDefaults) {
