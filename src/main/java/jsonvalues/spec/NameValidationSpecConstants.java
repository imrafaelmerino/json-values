...
class NameValidationSpecConstants {
    ...
    static final Predicate<String> isValidName = name -> AVRO_NAME_PATTERN.matcher(name).matches();
    static final Pattern AVRO_NAMESPACE_PATTERN = Pattern.compile(NAMESPACE_REGEX);
    static final Predicate<String> isValidNamespace = name -> AVRO_NAMESPACE_PATTERN.matcher(name).matches();
