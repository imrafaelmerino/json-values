 ...
 * leaving
 * the original array unchanged. This immutability ensures safe concurrent access and simplifies handling of JSON data.
 */
public final class JsArray implements Json<JsArray>, Iterable<JsValue> {
     ...
     * {@link JsArray}. It checks whether the given {@link JsValue} is actually an array and performs the conversion if
     * it is. Otherwise, it returns an empty {@link Optional}.
     */
     ...
     * they appear in the method's argument list. You can provide one or more strings to include in the resulting
     * array.
     *
     * <p>Example usage:
     * <pre>{@code
     ...
     * @throws NullPointerException if any of the provided string elements (including {@code str} and {@code others})
     *                              are null.
     */
     ...
     * they appear in the method's argument list. You can provide one or more integers to include in the resulting
     * array.
     *
     ...
     * in
     * the order they appear in the method's argument list. You can provide one or more {@link BigInteger} values to
     ...
     * the
     * order they appear in the method's argument list. You can provide one or more {@code double} values to include in
     * the resulting array.
     *
     ...
     * @return A new {@link JsArray} containing the converted {@link JsStr} elements from the specified {@link Collection}.
     */
     ...
     * @return A new {@link JsArray} containing the converted {@link JsInt} elements from the specified {@link Collection}.
     */
     ...
     * @return A new {@link JsArray} containing the converted {@link JsLong} elements from the specified {@link Collection}.
     */
     ...
     * @return A new {@link JsArray} containing the converted {@link JsBigDec} elements from the specified {@link Collection}.
     */
     ...
     * @return A new {@link JsArray} containing the converted {@link JsBool} elements from the specified {@link Collection}.
     */
     ...
     * @return A new {@link JsArray} containing the converted {@link JsInstant} elements from the specified {@link List}.
     */
     ...
     *
     * <p>The {@code ofStrs} method returns a new {@link JsArray} instance containing {@link JsStr} elements created from
     * the specified string values provided as varargs.
     *
     ...
     *
     * <p>The {@code ofInts} method returns a new {@link JsArray} instance containing {@link JsInt} elements created from
     * the specified integer values provided as varargs.
     *
     ...
     */
    public static JsArray ofInts(Integer... elements) {
        return of(Arrays.stream(elements).map(JsInt::of).toArray(JsValue[]::new));
    }

    /**
     * Creates a new {@link JsArray} from an array of {@link Long} elements.
     *
     * <p>The {@code ofLongs} method returns a new {@link JsArray} instance containing {@link JsLong} elements created from
     * the specified long values provided as varargs.
     *
    ...
    public static JsArray ofLongs(Long... elements) {
        return of(Arrays.stream(elements).map(JsLong::of).toArray(JsValue[]::new));
    }

    /**
     * Creates a new {@link JsArray} from an array of {@link BigDecimal} elements.
     *
     * <p>The {@code ofDecs} method returns a new {@link JsArray} instance containing {@link JsBigDec} elements created from
     * the specified {@link BigDecimal} values provided as varargs.
     *
    ...
    public static JsArray ofDecs(BigDecimal... elements) {
        return of(Arrays.stream(elements).map(JsBigDec::of).toArray(JsValue[]::new));
    }

    /**
     * Creates a new {@link JsArray} from an array of {@link Boolean} elements.
     *
     * <p>The {@code ofBools} method returns a new {@link JsArray} instance containing {@link JsBool} elements created from
     * the specified boolean values provided as varargs.
     *
    ...
    public static JsArray ofBools(Boolean... elements) {
        return of(Arrays.stream(elements).map(JsBool::of).toArray(JsValue[]::new));
    }

    /**
     * Creates a new {@link JsArray} from an array of {@link String} elements representing instant values.
     *
     * <p>The {@code ofInstants} method returns a new {@link JsArray} instance containing {@link JsInstant} elements created from
     * the specified string values provided as varargs.
     *
     ...
     */
    public static JsArray ofInstants(String... elements) {
     ...
     * {@link JsArray} containing the parsed JSON values. If the input byte array does not represent a valid JSON array,
     ...
     * @return A new {@link JsArray} containing the elements of this array followed by the elements from the source
     * array.
     * @see JsArray
     */
     ...
     * is returned as an {@code Integer}. If the value is not an integral number or cannot fit in an integer, this
     ...
     * <p>This method retrieves the JSON value at the specified index in the array and attempts to parse it as an
     * integral number. If the value at the index is a valid integral number that can be represented as an integer, it
     * is returned as an {@code Integer}. If the value is not an integral number or cannot fit in an integer, the
     * default value provided by the {@code orElse} supplier is returned.
     *
     * @param index  The index of the JSON value to retrieve as an integer.
     ...
     * @return The integral number located at the given index as a {@code Long}, or {@code null} if it doesn't exist or
     ...
     *
     * @param index  The index of the JSON value to retrieve as a long.
     * @param orElse A {@code Supplier} that provides the default value to return if the value at the given index is not
     *               a valid integral number or cannot fit in a long.
     ...
     * <p>This method retrieves the JSON value at the specified index in the array and attempts to interpret it as a
     * string. If the value at the index is a string, it is returned as a {@code String}. If the value is not a string,
     * or if it doesn't exist at the specified index, the {@code orElse} function is invoked to provide a default
     * value.
     *
     * @param index  The index of the JSON value to retrieve as a string.
     * @param orElse A {@code Supplier<String>} providing a default value if the value is not a string or doesn't
     *               exist.
    ...
    /**
     * Returns the instant located at the given index as an {@link Instant} or {@code null} if it doesn't exist or is
     * not a valid instant representation.
     *
     ...
     * @return The instant located at the given index as an {@link Instant}, or {@code null} if it doesn't exist or is
     * not a valid instant representation.
     */
     ...
     * into an array of bytes and returned. If the element does not exist at the specified index or is not a valid
     ...
     * @return An array of bytes representing the binary data at the specified index, or the default value provided by
     * the supplier if the data does not exist or is not a valid binary representation.
     */
    public byte[] getBinary(final int index,
     ...
     * @return The boolean value located at the given index, or null if it doesn't exist or the value at the index is
     * not a boolean.
     */
     ...
     * element at the given index is a valid boolean value, it is returned. If the element does not exist at the
     * specified index or is not a valid boolean representation, this method returns the result obtained from the
     * provided default value supplier.
     *
    ...
    /**
     * Retrieves the value located at the specified index within the JSON-like array and attempts to interpret it as a
     * decimal number, converting it to a double. If the value at the given index is a decimal number (either a double
     * or a BigDecimal), it returns the corresponding double value. If the value is not a decimal number or the index
     ...
     * converting a BigDecimal to a double, there may be a loss of information beyond the double's precision,
     * potentially leading to rounding or truncation.
     *
     * @param index The index at which to retrieve the value.
     * @return The double value located at the given index, or null if it doesn't exist, or the value at the index is
     ...
     * decimal number, converting it to a double. If the value at the given index is a decimal number (either a double
     * or a BigDecimal), it returns the corresponding double value. If the value is not a decimal number or the index
     * doesn't exist, it returns the default value provided by the {@code orElse} supplier.
     *
     * <p>The conversion process is designed to handle decimal numbers, but it's important to note that
     * if the value is a BigDecimal, the conversion to a double may result in a potential loss of precision. BigDecimal
     * numbers can represent decimal values with high precision, whereas double has limited precision. Therefore, when
     ...
     *               index doesn't exist.
     * @return The double value located at the given index, or the default value provided by {@code orElse} if it
     ...
     * BigDecimal or a double), it returns the corresponding BigDecimal value. If the value is not a decimal number or
     ...
     * decimal number, returning it as a BigDecimal. If the value at the given index is a decimal number (either a
     * BigDecimal or a double), it returns the corresponding BigDecimal value. If the value is not a decimal number or
     * the index doesn't exist, it returns the default BigDecimal value provided by the specified supplier.
     *
     * @param index  The index at which to retrieve the value.
     ...
     * BigInteger, long, or int), it returns the corresponding BigInteger value. If the value is not an integral number
     * or the index doesn't exist, it returns null.
     *
     * @param index The index at which to retrieve the value.
     ...
     * integral number, returning it as a BigInteger. If the value at the given index is an integral number (either a
     * BigInteger, long, or int), it returns the corresponding BigInteger value. If the value is not an integral number
     * or the index doesn't exist, it returns the default value provided.
     *
     * @param index  The index at which to retrieve the value.
     ...
     *
     * @param index  The index at which to retrieve the value.
     * @param orElse A supplier that provides the default JsObj if the index is out of bounds or the value at the index
    ...
    /**
     * Retrieves the value located at the specified index within the JSON-like array and attempts to interpret it as a
     * JSON array (JsArray). If the value at the given index is a JSON array, it returns the corresponding JsArray. If
     * the value is not a JSON array or the index doesn't exist, it returns null.
     *
     * @param index The index at which to retrieve the value.
     ...
     * Retrieves the value located at the specified index within the JSON-like array and attempts to interpret it as a
     * JSON array (JsArray). If the value at the given index is a JSON array, it returns the corresponding JsArray. If
     * the value is not a JSON array or the index doesn't exist, it returns the default value provided by the specified
     * Supplier.
     *
     * @param index  The index at which to retrieve the value.
    ...
    /**
     * Sets the value at the specified index within the JSON-like array to the provided JsValue. If the array size is
     * less than the specified index, it will be padded with the given padElement to accommodate the new value.
     *
    ...
    /**
     * Returns the element located at the specified index or {@link JsNothing} if it doesn't exist. This method is a
     * total function and never throws exceptions.
     *
