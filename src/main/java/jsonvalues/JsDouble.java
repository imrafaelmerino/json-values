...
public final class JsDouble extends JsNumber implements Comparable<JsDouble> {
  ...
  public boolean equals(final Object that) {
    ...
    if (number.isDouble()) {
      return value == number.toJsDouble().value;
    }
    if (number.isLong()) {
  ...
  /**
   * Converts this {@code double} to a {@code BigInteger}, checking for lost information.  An empty optional is returned
   * if this {@code double} has a nonzero fractional part.
   *
