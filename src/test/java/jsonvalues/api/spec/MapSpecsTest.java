...
class MapSpecsTest {
  ...
  @Test
  public void shouldParseNullableMapSpecsInsideObject() {
  ...
  @Test
  public void shouldValidateAndParseMapOfDouble() {
    JsObjSpec spec = JsObjSpec.of("a",
                                  JsSpecs.mapOfDouble());
  ...
  @Test
  public void shouldValidateAndParseMapOfBinary() {
    JsObjSpec spec = JsObjSpec.of("a",
                                  JsSpecs.mapOfBinary());
  ...
  @Test
  public void shouldAcceptNullForNullableMapSpecs() {
