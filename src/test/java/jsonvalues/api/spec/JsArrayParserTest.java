...
public class JsArrayParserTest {
  ...
  public void test_array_of_different_elements() {
    ...
    Assertions.assertEquals(array,
                            JsArraySpecParser.of(spec)
                                             .parse(array.toPrettyString())
                           );
  }
  ...
  public void testArrayOfObject() {
    ...
    Assertions.assertEquals(b,
                            JsObjSpecParser.of(specNullable)
                                           .parse(b.toString())
                           );
    ...
    JsObjGen gen = JsObjGen.of("a",
                               ...
                               JsArrayGen.arbitrary(seed -> () -> {
                                                      ...
                                                      if (l % 2 == 0) {
                                                        return JsBigDec.of(BigDecimal.valueOf(l));
                                                      }
    ...
    Assertions.assertTrue(gen.sample(100000)
                             .allMatch(d -> JsObjSpecParser.of(specSuchThat)
                                                           .parse(d.toString())
                                                           .equals(d)
                                      ));
  ...
  public void testArrayOfDouble() {
    ...
    JsArray array = JsArray.of(1 / 2d,
                               1 / 4d,
                               1 / 8d);

    Assertions.assertTrue(spec.test(array)
                              .isEmpty());
    Assertions.assertEquals(array,
                            parser.parse(array.toPrettyString()));

    Assertions.assertTrue(spec1.test(array)
                               .isEmpty());
    Assertions.assertEquals(array,
                            parser1.parse(array.toPrettyString()));
  ...
  public void testArrayOfValue() {
    ...
    Assertions.assertTrue(gen.suchThat(spec)
                             .sample(10000)
                             .allMatch(d -> parser.parse(d.toString())
                                                  .equals(d)
                                      ));

    Assertions.assertTrue(gen.suchThatNo(spec)
                             .sample(10000)
                             .allMatch(d -> {
                                         try {
