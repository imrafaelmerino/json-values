...
public class RecursiveTypeTest {
  ...
  public void shouldWithBuilder() {
    ...
    var person = JsObj.of("name",
                          ...
                          JsObj.of("name",
                                   ...
                                   JsInt.of(73),
                                   "image",
                                   JsBinary.of("b".getBytes(StandardCharsets.UTF_8))
                                  )
                         );
  ...
  @Test
  public void shouldWitNamedSpecMethod() {
