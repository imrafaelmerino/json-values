...
public class BigDecGenTest {


  @Test
  public void shouldBiasedBigDecimalInterval() {

    Map<JsBigDec, Long> counts =
        FunTest.generate(100000,
                         JsBigDecGen.biased(BigDecimal.valueOf(-100000000000000000L),
                                            BigDecimal.valueOf(100000000000000000L)));

    List<JsBigDec> problematic = FunTest.list(
                                            BigDecimal.valueOf(100000000000000000L),
                                            BigDecimal.valueOf(-100000000000000000L),
  ...
  @Test
  public void shouldBiasedBigDecimal() {

    Map<JsBigDec, Long> counts = FunTest.generate(500000,
                                                  JsBigDecGen.biased());

    List<JsBigDec> problematic = FunTest.list(JsBigDec.of(BigDecimal.valueOf(Long.MAX_VALUE)),
