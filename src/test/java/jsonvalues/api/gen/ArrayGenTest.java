...
public class ArrayGenTest {
  ...
  public void shouldArbitrary() {
    ...
    Map<Integer, Long> count = FunTest.generate(100000,
  ...
  public void shouldBiased() {
    ...
    Assertions.assertTrue(FunTest.isInMargin(count.get(0),
                                             0.1)
                                 .test(count.get(3)));
    Assertions.assertTrue(FunTest.isInMargin(count.get(1),
                                             0.1)
                                 .test(count.get(2)));
