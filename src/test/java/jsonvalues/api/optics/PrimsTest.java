...
public class PrimsTest {
  ...
  @Test
  public void shouldIntegerPrism() {
  ...
  public void shouldBinaryPrism() {
    ...
    Assertions.assertTrue(JsBinary.prism.getOptional.apply(JsBinary.of("hola"))
                                                    .isPresent());
    Assertions.assertArrayEquals(JsBinary.prism.getOptional.apply(JsStr.of("hola"))
                                                           .get()
        ,
                                 JsBinary.prism.getOptional.apply(JsBinary.of("hola"))
                                                           .get());
  }


  @Test
  public void shouldInstantPrism() {
    Assertions.assertTrue(JsInstant.prism.isEmpty.test(JsStr.of("a")));
    Assertions.assertTrue(JsInstant.prism.getOptional.apply(JsStr.of(Instant.now()
                                                                            .toString()))
                                                     .isPresent());
    Assertions.assertFalse(JsInstant.prism.getOptional.apply(JsStr.of(LocalDateTime.now(ZoneId.systemDefault())
                                                                                   .toString()))
                                                      .isPresent());
  }

  @Test
  public void shouldBigIntPrism() {
