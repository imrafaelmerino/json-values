...
public class JsArrayOpticsTest {
  ...
  @Test
  public void shouldBigIntLensesByPath() {
  ...
  @Test
  public void shouldBigIntLenses() {
  ...
  @Test
  public void shouldLongLensesByPath() {
  ...
  @Test
  public void shouldIntegerLensesByPath() {
  ...
  @Test
  public void shouldBooleanLensesByPath() {
  ...
  @Test
  public void shouldBooleanLenses() {
  ...
  @Test
  public void shouldArrayBinaryLensesByPath() {
  ...
  @Test
  public void shouldArrayBinaryLenses() {
  ...
  @Test
  public void shouldArrayInstantLensesByPath() {
  ...
  @Test
  public void shouldArrayInstantLenses() {
  ...
  @Test
  public void shouldArrayStrLensesByPath() {
  ...
  @Test
  public void shouldArrayStrLenses() {
  ...
  @Test
  public void shouldArrayStrOption() {
  ...
  @Test
  public void shouldArrayIntOption() {
  ...
  @Test
  public void shouldArrayLongOption() {
  ...
  @Test
  public void shouldArrayBigIntOption() {
  ...
  @Test
  public void shouldArrayBigDecOption() {
  ...
  @Test
  public void shouldArrayBoolOption() {
  ...
  @Test
  public void shouldArrayDoubleOption() {
  ...
  @Test
  public void shouldArrayOptionalsByPathForCompoundValues() {

    JsPath objPath = JsPath.path("/0/a");
    JsPath arrayPath = JsPath.path("/0/b");
    JsPath instantPath = JsPath.path("/0/c");
    ...
    Assertions.assertEquals(Optional.of(JsObj.of("x",
                                                 JsInt.of(1))),
                            JsArray.optional.obj(objPath)
                                            .get.apply(array));

    Assertions.assertEquals(Optional.of(JsArray.of(1,
                                                   2)),
                            JsArray.optional.array(arrayPath)
                                            .get.apply(array));

    Assertions.assertEquals(Optional.of(now),
                            JsArray.optional.instant(instantPath)
                                            .get.apply(array));
  }

  @Test
  public void shouldArrayOptionalsWithWrongTypeAndMissingValues() {

    JsArray array = JsArray.of(JsStr.of("not-an-object"),
                               JsInt.of(2));

    Assertions.assertEquals(Optional.empty(),
                            JsArray.optional.obj(0)
                                            .get.apply(array));
    Assertions.assertEquals(Optional.empty(),
                            JsArray.optional.array(0)
                                            .get.apply(array));
    Assertions.assertEquals(Optional.empty(),
                            JsArray.optional.instant(0)
                                            .get.apply(array));
    Assertions.assertEquals(Optional.empty(),
                            JsArray.optional.str(99)
                                            .get.apply(array));
  }

  @Test
  public void shouldArrayPathValidationForLensAndOptional() {

    JsPath keyHeadPath = JsPath.path("/a");

    Assertions.assertThrows(UserError.class,
                            () -> JsArray.lens.str(keyHeadPath));
    Assertions.assertThrows(UserError.class,
                            () -> JsArray.optional.str(keyHeadPath));
    Assertions.assertThrows(UserError.class,
                            () -> JsArray.optional.obj(keyHeadPath));
    Assertions.assertThrows(UserError.class,
                            () -> JsArray.optional.array(keyHeadPath));
  }
