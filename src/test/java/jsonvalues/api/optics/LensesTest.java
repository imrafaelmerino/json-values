...
public class LensesTest {
  ...
  public void shouldGet() {
    ...
    Assertions.assertArrayEquals("hola".getBytes(StandardCharsets.UTF_8),
                                 bytes.get.apply(obj));
  ...
  public void shouldBinaryLens() {
    ...
    JsObj a = JsObj.of("a",
                       JsBinary.of("hola".getBytes(StandardCharsets.UTF_8)));
    JsObj newObj = binaryLens.modify.apply(it -> (new String(it,
                                                             StandardCharsets.UTF_8) + "adios")
  ...
  public void shouldInstantLens() {
    ...
    JsObj a = intantLens.set.apply(now)
                            .apply(JsObj.empty());
    JsObj b = intantLens.modify.apply(i -> i.plusSeconds(100))
                               .apply(a);
