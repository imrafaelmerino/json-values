...
public class AliasSpecTest {

  static Supplier<String> nameGen = StrGen.alphabetic(10,
                                                      10)
                                          .sample();
  ...
  @Test
  public void shouldNotErrorBecauseAliasIsFound() {
    ...
    Assertions.assertTrue(spec.test(JsObj.of("a1",
                                             JsInt.of(1)))
                              .isEmpty());
    Assertions.assertTrue(spec.test(JsObj.of("a1",
                                             JsNull.NULL))
                              .isEmpty());
    Assertions.assertFalse(spec.test(JsObj.of("a1",
                                              JsBool.FALSE))
                               .isEmpty());
    Assertions.assertFalse(spec.lenient()
                               .test(JsObj.of("a1",
                                              JsBool.FALSE))
                               .isEmpty());

    Assertions.assertTrue(spec.test(JsObj.of("a2",
                                             JsInt.of(1)))
                              .isEmpty());
    Assertions.assertTrue(spec.test(JsObj.of("a2",
                                             JsNull.NULL))
                              .isEmpty());
    Assertions.assertFalse(spec.test(JsObj.of("a2",
                                              JsBool.FALSE))
                               .isEmpty());
    Assertions.assertFalse(spec.lenient()
                               .test(JsObj.of("a2",
    ...
    Assertions.assertFalse(spec.test(JsObj.of("a3",
                                              JsInt.of(1)))
                               .isEmpty());
    Assertions.assertTrue(spec.withAllOptKeys()
                              .lenient()
                              .test(JsObj.of("a3",
                                             JsInt.of(1)))
                              .isEmpty());
