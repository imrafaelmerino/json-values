...
class ParsersMetadataTest {

  @Test
  void shouldApplyAliasesAndDefaultsWhenParsing() {
  ...
  @Test
  void shouldEnforceMinAndMaxObjectPropertiesInParserAndTest() {
  ...
  @Test
  void shouldEnforceArraySizeMetadataInParserAndTest() {
  ...
  @Test
  void shouldTreatDefaultsAsSatisfyingRequiredFieldsInTestAndParser() {
    JsObjSpec spec =
        JsObjSpecBuilder.withName("defaultsRequired")
                        .withFieldsDefaults(Map.of("id",
                                                   JsStr.of("auto")))
                        .build(JsObjSpec.of("id",
                                            str()));

    JsObjSpecParser parser = JsObjSpecParser.of(spec);
    JsObj parsed = parser.parse("{}");

    Assertions.assertEquals(JsObj.of("id",
                                     JsStr.of("auto")),
                            parsed);
