...
import static jsonvalues.gen.state.JsStateGens.ifContains;
import static jsonvalues.gen.state.JsStateGens.ifNotContains;
...
public class TestJsObjStateGen {
    ...
    public void a() {
        ...
        for (int i = 0; i < 10; i++) {
            System.out.println(gen.apply(JsObj.empty())
                                  .apply(new Random())
                                  .get());
        }
    }
