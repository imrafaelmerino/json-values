  ...
  property("appends a json array")
  {
    check(forAll(jsPathGen.arrayPathGen,
          ...
          { (path,
            ...
            array.getArray(path).size() == a.size() &&
  ...
  property("appends a json array if exists the target")
  {
    check(forAll(jsPathGen.arrayPathGen,
          ...
          { (path,
            ...
            !empty.getArrayOpt(path).isPresent && notEmpty.getArray(path).equals(JsArray.of(1).appendAll(a))
          }
          )
  }
  ...
  property("prepends a json array if exists the target")
  {
    check(forAll(jsPathGen.arrayPathGen,
          ...
          { (path,
            ...
            !empty.getArrayOpt(path).isPresent && notEmpty.getArray(path).equals(JsArray.of(1).prependAll(a))
          }
          )
  }
